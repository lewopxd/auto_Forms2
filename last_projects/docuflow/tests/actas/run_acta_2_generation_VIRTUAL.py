...
"""
Project: DocuFlow
File:  run_acta_2_generation_VIRTUAL.py
Created: 2025-11-06
Author: @lewopxd

Description:
Script de "producción" para generar el lote de documentos 
"ACTA 2 - HABILIDADES BLANDAS (VIRTUAL)".
...
# --- [ RUTA ACTUALIZADA ] ---
TEMPLATE_FILE_PATH = r"C:\Users\Admin\Desktop\FASE3-APROBADOS\FASE 3 - INTERMEDIACION LABORAL\PLANTILLAS ACTAS\ACTA 2 - HABILIDADES BLANDAS\02_VIRTUAL.pdf"
...
BASE_CONFIG = {
    ...
    "job_config": {
        ...
        # --- [ FILTRO CORREGIDO ] ---
        # === FILTRO: (Habilidades == 'Virtual') Y (Estado == 'OK') ===
        "filter_rules": {
            "AND": [
                {"column": "E2. HABILIDADES BLANDAS", "operator": "equal", "value": "Virtual"}, # Corregido de "VIRTUAL" a "Virtual"
        ...
        "filename_pattern": {
            "template": "ACTA 2 - VIRTUAL - {[NOMBRES]} {[APELLIDOS]}.pdf", # <- Extensión .pdf
           "columns": [
                {"name": "NOMBRES", "transforms": [
                    {"type": "regex_replace", "pattern": "\\b(NA|na)\\b", "replacement": ""},
                    {"type": "regex_replace", "pattern": "\\s+", "replacement": " "},
...
if __name__ == "__main__":
    print(f"╔══════════════════════════════════════════════════════════════╗")
    print(f"║   SCRIPT DE GENERACIÓN - ACTA 2 (HAB. VIRTUAL)               ║")
    print(f"╚══════════════════════════════════════════════════════════════╝")
    ...
    for i, job in enumerate(JOBS_TO_RUN, 1):
        ...
        print("     - 'E2. HABILIDADES BLANDAS' == 'Virtual'") # <- Corregido
